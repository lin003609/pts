...
public class Order
{
    ...
    public float getJpjg() { return jpjg; }
    public void setJpjg(float jpjg) { this.jpjg = jpjg; }

    public float getAirPortTax() { return airPortTax; }
    public void setAirPortTax(float airPortTax) { this.airPortTax = airPortTax; }
    ...
    public Set<Customer> getCustomersSet() { return customersSet; }
    public void setCustomersSet(Set<Customer> customersSet) { this.customersSet = customersSet; }
